package com.peculiaruc.contactme
...
import com.peculiaruc.contactme.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setUpAlerDialong(binding: ActivityMainBinding) {
